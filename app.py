                ...
                if data.empty:
                    ...
                    for y in years:
                        ...
                        if not year_data.empty:
                            ...
                            # 연도 표시 간격을 조절하기 위해 y 좌표를 1.05에서 1.02로 변경하여 차트 쪽으로 밀착시킴
                    ...
                    # 여유로운 레이아웃 확보를 위해 상단 마진(t)을 120에서 150으로 확대
                    # 범례의 y 위치를 1.02에서 1.10으로 올려 연도 표시와 겹치거나 붙지 않도록 간격 확보
                    fig.update_layout(
